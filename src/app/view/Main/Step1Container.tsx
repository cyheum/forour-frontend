  ...
  return (
    <STDContainer>
      ...
      <AnniversaryListLayout>
        ...
        <ListLayout>
          <List onTouchStart={() => document.body.style.overflow = "hidden"} onTouchEnd={()=>document.body.removeAttribute("style")}>
            <Slider {...settings}
            >
          {
            TEST.map((v, i) => {
...
const TEST = [{ type: "Friendship", value: "우정" }, { type: "Love", value: "사랑" },
  { type: "50th", value: "50일" },
